...
export class ObservableDefaultApi {
     ...
     */
    public instancesGet(_options?: Configuration): Observable<void> {
     ...
     */
    public instancesIdGet(id: string, _options?: Configuration): Observable<void> {
     ...
     */
    public instancesPost(_options?: Configuration): Observable<void> {
